...
-- ----------------------------
INSERT INTO tbl_order_number VALUES ('219');
...
CREATE TABLE `tbl_purchase_order_header` (
  ...
  `date_enter` datetime DEFAULT NULL,
  `date_update` datetime DEFAULT NULL,
  PRIMARY KEY (`purchase_order_id`,`purchase_order_no`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of tbl_purchase_order_header
-- ----------------------------
INSERT INTO tbl_purchase_order_header VALUES ('1', '00000000000000000215', '1', 'DO3', 'Puregold Zabarte', 'Ma.Anjellica B. San Miguel', '0.00', '2016-08-01 10:34:55', null);
INSERT INTO tbl_purchase_order_header VALUES ('1', '00000000000000000218', '1', 'DO3', 'Puregold Zabarte', 'Ma.Anjellica B. San Miguel', '0.00', '2016-08-01 10:48:34', null);
INSERT INTO tbl_purchase_order_header VALUES ('1', '00000000000000000219', '1', 'DO3', 'Puregold Zabarte', 'Ma.Anjellica B. San Miguel', '0.00', '2016-08-01 10:52:13', null);
